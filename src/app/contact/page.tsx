  ...
  return (
    <main className="min-h-screen pb-16">
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-12 lg:px-8">
        ...
        <section className="mt-6 grid gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-4">
          <ContactCard
            icon={Bug}
            title="Open an issue"
...
function ContactCard({
  ...
  return (
    <div className="rounded-[1.25rem] border border-border/60 bg-card/75 p-4 shadow-[0_18px_50px_-36px_rgba(15,23,42,0.45)] backdrop-blur transition hover:-translate-y-0.5 hover:border-foreground/15 hover:shadow-lg sm:rounded-[1.5rem] sm:p-6">
