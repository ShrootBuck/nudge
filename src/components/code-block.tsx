...
export function CodeBlock({
  ...
  const renderedCode = preHighlightedHtml ? (
    <>
      <div
        className="dark:hidden [&_.shiki]:!m-0 [&_.shiki]:max-w-full [&_.shiki]:overflow-x-auto [&_.shiki]:!rounded-none [&_.shiki]:!p-4 [&_.shiki]:text-[13px] sm:[&_.shiki]:!p-6 sm:[&_.shiki]:text-sm [&_code]:text-[13px] sm:[&_code]:text-sm"
      ...
      />
      <div
        className="hidden dark:block [&_.shiki]:!m-0 [&_.shiki]:max-w-full [&_.shiki]:overflow-x-auto [&_.shiki]:!rounded-none [&_.shiki]:!p-4 [&_.shiki]:text-[13px] sm:[&_.shiki]:!p-6 sm:[&_.shiki]:text-sm [&_code]:text-[13px] sm:[&_code]:text-sm"
        // biome-ignore lint: html is generated by shiki from code content, not user input
        dangerouslySetInnerHTML={{ __html: preHighlightedHtml.dark }}
      />
    </>
  ) : html === null || html === "" ? (
    <pre className="max-w-full overflow-x-auto bg-slate-950/95 p-4 text-slate-50 sm:p-6">
      <code className="font-mono text-[13px] sm:text-sm">{code}</code>
    </pre>
  ) : (
    <div
      className="[&_.shiki]:!m-0 [&_.shiki]:max-w-full [&_.shiki]:overflow-x-auto [&_.shiki]:!rounded-none [&_.shiki]:!p-4 [&_.shiki]:text-[13px] sm:[&_.shiki]:!p-6 sm:[&_.shiki]:text-sm [&_code]:text-[13px] sm:[&_code]:text-sm"
      // biome-ignore lint: html is generated by shiki from code content, not user input
