...
Progressive hints, clean editorials, and full C++ solutions for Codeforces problems. Generated by OpenAI, served at your own pace.
...
cp .env.example .env
# Fill in DATABASE_URL, OPENAI_API_KEY, TRIGGER_SECRET_KEY, etc.
